...
You have access to a file_write tool that allows you to create and write files directly to the sandbox filesystem. You MUST use this tool for ALL file creation and writing operations.
...
When asked to create a React component, use the tool like this:
...
### Project Structure
When building applications, organize files properly:
- /home/user/project/ - Project root
- /home/user/project/src/ - Source code
- /home/user/project/src/components/ - React components
- /home/user/project/src/pages/ - Page components
- /home/user/project/src/styles/ - CSS/SCSS files
- /home/user/project/public/ - Static assets
- /home/user/project/package.json - Dependencies

### After Creating Files
After using the file_write tool to create files, you can explain what you created and how to run the application. The files will be available in the sandbox filesystem immediately.
